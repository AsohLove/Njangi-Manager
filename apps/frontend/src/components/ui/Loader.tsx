export function SkeletonLoader() {
  return (
    <div className="min-h-screen bg-emerald-50/50 flex items-start justify-center font-sans">
      <div className="w-full bg-emerald-50/20 overflow-hidden flex flex-col min-h-[580px] animate-pulse">
        {/* Header Skeleton */}
